        ...
        <div class="card-body d-flex row">
          <form class="form d-flex gap-2" method="POST" action="<?php echo $_SERVER['PHP_SELF']?>">
            ...
            <div class="input-group input--small">
              ...
              <input class="input--style-1" type="number" min="2000" step="1000" name="priceMax" placeholder="Max price"
                id="minPrice">
            </div>
            <div class="input-group input--medium">
              <label class="label">Min Price</label>
              <input class="input--style-1" type="number" min="2000" step="1000" name="priceMin" placeholder="Min price"
                id="maxPrice">
            </div>
          ...
          <div class="modal-body">
            <form>
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="announce-name">
              </div>
              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Announce Price :</label>
                <input type="number" class="form-control" id="announce-price">
              </div>
              <div class="mb-3">
                <div class="mb-3">
                  <label for="recipient-name" class="col-form-label">Announce Picture :</label>
                  <input type="url" class="form-control" id="announce-pic" placeholder="Type URL here..">
                </div>
                <div class="mb-3">
                  <label for="recipient-name" class="col-form-label">Announce Category :</label>
                  <select class="form-select input-xs " id="category">
                    <option selected>Category</option>
                    <option value="1">Rent</option>
                    <option value="2">Buy</option>
                  </select>
                ...
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control" id="announce-date">
                </div>
                <div class="mb-3">
                  <label for="recipient-name" class="col-form-label">Announce Description :</label>
                  <textarea class="form-control" id="announce-desc"></textarea>
                </div>
  ...
  foreach ( $searchResult as $key => $value) {
    ...
    <div class="card item-card card-block ">
        ...
        <div class="groupBtn mb-3 p-2">
          <button class=" btn-success btn update" id="editBtn" onclick="editAnnounce(<?php echo $value['id'] ?>)" data-bs-toggle="modal"
            data-bs-target="#updateModal">Update</button>
            <button data-bs-toggle="modal" onclick="DeleteAnnounce(<?php echo $value['id'] ?>)" data-bs-target="#DeleteArticle" class=" btn-danger btn delete"
            id="delete">Delete</button>
            <a href="#" data-bs-toggle="modal" onclick="AnnounceDetails(<?php echo $value['id'] ?>)" class=" btn-danger btn delete"
            id="delete">Details</a>
        </div>
